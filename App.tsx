...
import { Calendar, MapPin, User, Star, Mic, PenTool, Mail, Facebook, Instagram, Send, Download, Camera, ExternalLink, Map, Twitter, MessageCircle, Cloud, Zap, Heart } from 'lucide-react';
...
const partners = [
  ...
  { name: "SONOCO", logo: IMAGES.PARTNERS.SONOCO },
  { name: "Orange", logo: IMAGES.PARTNERS.ORANGE },
  { name: "Ambassade du Japon", logo: IMAGES.PARTNERS.JAPON },
  { name: "Institut Français", logo: IMAGES.PARTNERS.IF },
  { name: "RTG", logo: IMAGES.PARTNERS.RTG },
  { name: "Salam", logo: IMAGES.PARTNERS.SALAM },
  { name: "Traiteur Bissa", logo: IMAGES.PARTNERS.BISSA },
  { name: "Ambassade d'Allemagne", logo: IMAGES.PARTNERS.ALLEMAGNE }
];
...
>
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="mt-12 flex flex-col md:flex-row gap-4 justify-center items-center flex-wrap">
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLScOkRjlKrNGNzsSXccIoBy5BJmM7HsTU3bsGJBSEhGBh4ztaw/viewform?usp=dialog"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 bg-blue-600 text-white font-comic-header text-2xl px-8 py-4 border-4 border-black shadow-comic hover:shadow-comic-hover hover:-translate-y-1 transition-all transform hover:rotate-1 animate-pulse hover:animate-none"
            >
            ...
            <button
              ...
              className="bg-fibeg-red text-white font-comic-header text-2xl px-8 py-4 border-4 border-black shadow-comic hover:shadow-comic-hover hover:-translate-y-1 transition-all transform hover:rotate-1"
            >
              DÉCOUVRIR LE PROGRAMME
            </button>
            <a
              href="https://raw.githubusercontent.com/TIADRA432/FIBEG/refs/heads/main/Programmation%20officielle%20BON.pdf"
              download
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-fibeg-yellow text-black font-comic-header text-2xl px-8 py-4 border-4 border-black shadow-comic hover:shadow-comic-hover hover:-translate-y-1 transition-all transform hover:-rotate-1"
            >
